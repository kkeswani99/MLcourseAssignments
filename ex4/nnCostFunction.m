...
for i=1:m
for k=1:num_labels
var = var + Y(i,k)*log(a3(i,k)) + (1-Y(i,k))*log(1-a3(i,k));
end;
end;
var = var/m;
J = -var;
...
temp = temp';
del2 = (Theta2')*delcol3.*temp;
del2 = del2(2:end);
DELTA1 = DELTA1 + del2*(a_1);
DELTA2 = DELTA2 + delcol3*(a_2);
end;
...
Theta1_grad = DELTA1 + Theta1 ;
Theta2_grad = DELTA2 + Theta2;
% -------------------------------------------------------------
